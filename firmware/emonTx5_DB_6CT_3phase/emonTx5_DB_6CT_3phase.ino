...
Change Log:
v1.0.0: Based on emonPi2_DB_6CT_3phase
v1.1.0: First release of emonTx5_DB_6CT_3phase
...
// Include emonTx5_DB_6CT_3phase_config.ino in the same directory for settings functions & data
...
//---------------------------- emonTx5 Settings - Stored in EEPROM and shared with config.ino ------------------------------------------------
struct {
...
{  
  ...
  #ifdef DEBUG
    Serial.print(F("emonTx5_DB_6CT_3phase V")); Serial.write(firmware_version);
    Serial.println(F("OpenEnergyMonitor.org"));
  #else
    Serial.println(F("describe:emonTx5_DB_6CT_3phase"));
  #endif
