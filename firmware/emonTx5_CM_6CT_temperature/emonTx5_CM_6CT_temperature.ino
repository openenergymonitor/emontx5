...
{  
  ...
  #ifdef DEBUG
    Serial.print(F("emonTx5_CM_6CT_temperature V")); Serial.write(firmware_version);
    Serial.println(F("OpenEnergyMonitor.org"));
  #else
    Serial.println(F("describe:emonTx5_CM_6CT_temperature"));
  #endif
  ...
  EmonLibCM_setTemperatureDataPin(PIN_PB4);                            // OneWire data pin (emonTx5)
  EmonLibCM_setTemperaturePowerPin(PIN_PC1);                           // Temperature sensor Power Pin - 19 for emonTx5  (-1 = Not used. No sensors, or sensor are permanently powered.)
